...
<div class="academic-home">
  ...
  <section class="academic-section" id="projects">
    ...
    <div class="project-list">
      ...
      <article class="project-row">
        <div class="project-heading"><h3><i class="project-title-icon fas fa-folder-open" aria-hidden="true"></i><a href="http://mingqi.sh.cn/">“Mingqi” Medical Imaging Large Model Matrix</a></h3><div class="project-meta"><span>Subproject Leader</span><time>Dec. 2024 – Oct. 2025</time></div></div>
